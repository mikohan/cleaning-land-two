    ...
    <Fragment>
      <div className="container">
        <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
          <h1 className="wp-block-post-title">Privacy Policy</h1>
        </div>
        <div className="entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained">
          ...
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>Our website address is:
            {site}
          </p>
          <h2 className="wp-block-heading">Comments</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>When visitors leave comments on
            the site we collect the data shown in the comments form, and also the visitor&rsquo;s IP address and browser
          ...
          <p>
            ...
            {site}. After approval of your comment, your profile picture is visible to the public in the context of your
            comment.
          </p>
          <h2 className="wp-block-heading">Media</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>If you upload images to the
            website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the
            website can download and extract any location data from images on the website.
          </p>
          <h2 className="wp-block-heading">Cookies</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>If you leave a comment on our site
            you may opt-in to saving your name, email address and website in cookies. These are for your convenience so
            that you do not have to fill in your details again when you leave another comment. These cookies will last
            for one year.
          </p>
          <p>
          ...
          <p>
            ...
            "Remember Me", your login will persist for two weeks. If you log out of your account, the login cookies will
            be removed.
          </p>
          <p>
          ...
          <h2 className="wp-block-heading">Embedded content from other websites</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>Articles on this site may include
            embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the
          ...
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>If you request a password reset,
            your IP address will be included in the reset email.
          </p>
          <h2 className="wp-block-heading">How long we retain your data</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>If you leave a comment, the
            comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up
          ...
          <h2 className="wp-block-heading">What rights you have over your data</h2>
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>If you have an account on this
            site, or have left comments, you can request to receive an exported file of the personal data we hold about
            you, including any data you have provided to us. You can also request that we erase any personal data we
          ...
          <p>
            <strong className="privacy-policy-tutorial">Suggested text:&nbsp;</strong>Visitor comments may be checked
            through an automated spam detection service.
          </p>
        </div>
        <section className="wp-block-template-part"></section>
      </div>
    </Fragment>
  );
};
